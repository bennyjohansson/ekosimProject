...
Consumer *random_consumer(string country, Market *market, Market *global_market, Bank *bank, Clock *clock)
{
    ...
    return new Consumer(mot, sk, cap, spe, save, borrow, country, market, global_market, bank, clock);
}
...
double item_efficiency_increase(double items, double parameter1_rate, double item_efficiency)
{
    ...
    int item_efficiency_function = 3;
    ...
    case 3:
        // item_efficiency_increase = scaling * (1 - exp(-parameter1_rate * items)) * item_efficiency;
        item_efficiency_increase = scaling * (1 - exp(-parameter1_rate * items)) * item_efficiency * item_efficiency;
        break;
