...
CCFLAGS = -g -Wall -v   -lsqlite3 -std=c++17 -lstdc++ -I/usr/lib64/mysql/  -W -lmysqlclient #-I/usr/local/include -I/usr/local/opt/sqlite/include -L/usr/local/opt/sqlite/lib -stdlib=libc++ 
