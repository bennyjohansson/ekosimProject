...
CCFLAGS = -g -Wall -v   -lsqlite3 -std=c++17 -lstdc++ -ICellar/mysql/8.0.23_1/include/mysql  -W -lmysqlclient #-I/usr/local/include -I/usr/local/opt/sqlite/include -L/usr/local/opt/sqlite/lib -stdlib=libc++ 
