...
public:
   ...
   void set_dividend_ratio(double);
   void set_liquidity_reserve_ratio(double);
   void set_capital_reserve_ratio(double);
   ...
   void change_dividend_ratio(double);
   void change_liquidity_reserve_ratio(double);
   void change_capital_reserve_ratio(double);
...
private:
   ...
   double loans_;
   double liquidity_;
   double capital_reserve_ratio_;
   double liquidity_reserve_ratio_;
   double trustworthy_;
